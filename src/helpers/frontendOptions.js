    ...
    if (pwaConfig) {
        ...
        return `
            :root {
                ...
                --color-pwa-button_background_color: ${button_background_color || COLORS.primary[500]};
                --color-pwa-button_background_hover_color: ${button_background_hover_color || COLORS.primary[200]};
