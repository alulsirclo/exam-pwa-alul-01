            ...
            <div className="flex flex-col gap-2 tablet:gap-4">
                ...
                <div className="flex flex-row gap-1 items-center w-full justify-center">
                    <Show when={showAddToCart && !viewItemOnly}>
                        <Button
                            iconProps={{ className: 'w-4 h-4 flex' }}
                            disabled={disabled}
                            ...
                            <div className="flex-row gap-1 hidden tablet:flex desktop:flex">
                                <Show when={showWishlist && !usedInWishlist}>
                                    <Button
                                        ...
                                        onClick={() => handleFeed(props)}
                                        className={classNames(
                                            'swift-action-towishlist !p-[10px] !border-neutral-200',
                                            'hover:!shadow-none focus:!shadow-none hover:!opacity-100', 'w-[38px]', 'invisible',
                                            'desktop:group-hover:visible', 'absolute', 'left-1/3 bottom-4 -translate-x-1 z-[2] w-32',
                                        )}
                                    />
                                </Show>
                                <Show when={usedInWishlist}>
                                    <Button
                                        ...
                                        onClick={() => handlingRemove()}
                                        className={classNames(
                                            'swift-action-toremove !p-[10px] !border-neutral-200',
                                            'hover:!shadow-none focus:!shadow-none hover:!opacity-100', 'w-[38px]', 'invisible',
                                            'desktop:group-hover:visible', 'absolute px-3 py-2', 'left-1/2 bottom-4 -translate-x-1/2 z-[2] w-32',
                                        )}
                                    />
                                </Show>
                                <Show when={showProductCompare}>
                                    <Button
                                        ...
                                        onClick={() => handleSetCompareList(props?.id)}
                                        className={classNames(
                                            'swift-action-tocompare !p-[10px] !border-neutral-200',
                                            'hover:!shadow-none focus:!shadow-none hover:!opacity-100', 'w-[38px]', 'invisible',
                                            'desktop:group-hover:visible', 'absolute px-3 py-2', 'right-1/4 bottom-4 -translate-x-1/2 z-[2] w-32',
                                        )}
                                    />
                                </Show>
                            </div>
