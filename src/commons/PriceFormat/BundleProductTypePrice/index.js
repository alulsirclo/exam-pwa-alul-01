...
const BundleProductTypePrice = ({
    ...
    if (priceRange.maximum_price.final_price.value === priceRange.minimum_price.final_price.value) {
        return (
            <Typography variant={priceLabelVariant} className={cx('price-text', 'text-neutral-800', 'font-semibold', textClassName)}>
        ...
        return (
            <div className="flex flex-col">
                ...
                <div>
                    ...
                    <Typography variant={priceLabelSubVariant} className={cx('price-text', 'text-neutral-800', 'font-semibold', textClassName)}>
                        {formatPrice(
    ...
    return (
        <div className={cx('flex flex-row flex-wrap')}>
            <Typography variant={priceLabelVariant} className={cx('price-text-min', 'text-neutral-800', 'font-semibold', textClassName)}>
                {formatPrice(priceRange.minimum_price.final_price.value + otherPrice, priceRange.minimum_price.final_price.currency, currencyCache)}
            </Typography>
            <Typography variant={priceLabelVariant} className={cx('price-text-seperate', 'text-neutral-800', 'font-semibold', 'mx-1')}>
                -
            </Typography>
            <Typography variant={priceLabelVariant} className={cx('price-text-max', 'text-neutral-800', 'font-semibold', textClassName)}>
