...
const SimpleProductTypePrice = ({
                        ...
                        {!isPdp && !isQuickView && (
                            <div>
                                ...
                                <Typography
                                    ...
                                    className={cx('price-text', 'text-neutral-800', 'font-semibold',
                                        textClassName)}
                                >
    ...
    if (regularPrice.value === finalPrice.value) {
        return (
            <Typography variant={priceLabelVariant} className={cx('price-text', 'text-neutral-800', 'font-semibold', 'price-case-8', textClassName)}>
                {formatPrice(finalPrice.value + otherPrice, finalPrice.currency, currencyCache)}
            </Typography>
        );
    }
