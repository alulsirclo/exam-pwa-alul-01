                ...
                >
                    <Button
                        ...
                        className={cx(
                            ...
                            'bg-neutral-900',
                            'bg-opacity-40',
                            'rounded-[99%] !important',
                            leftNavClassName,
                        )}
                        classNameText="!text-neutral group-hover/left-nav:!text-primary"
                        onClick={onClickArrowLeft}
                    >
                        <ChevronLeftIcon className="w-6 h-6" style={{ width: arrowSize, height: arrowSize, color: '#FFFFFF' }} />
                    </Button>
                    <Button
                        variant="plain"
                        className={cx(
                    ...
                    >
                        <ChevronRightIcon className="w-6 h-6" style={{ width: arrowSize, height: arrowSize, color: '#FFFFFF' }} />
                    </Button>
                </div>
            </Show>
            <div
